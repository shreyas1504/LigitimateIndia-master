  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Highlights', style: boldTextStyle(size: 20)),
        elevation: 0,
        centerTitle: true,
      ),
          ...
          children: [
            if (highlightList.isNotEmpty)
              Align(
                ...
                child: TextButton(
                  ...
                  child: Text(showNewCategory ? 'Select Highlight' : 'Create New', style: primaryTextStyle(color: context.primaryColor)),
                ),
              ),
            ...
            if (showNewCategory.validate())
              Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Story Highlight Image', style: boldTextStyle()),
                  16.height,
                  DottedBorderWidget(
                    radius: 60,
                    dotsWidth: 8,
                    ...
                    child: categoryImage == null
                        ? InkWell(
                            ...
                            child: Container(
                              ...
                              height: 120,
                              width: 120,
                              child: Text('Select Image', style: secondaryTextStyle()).center(),
                            ),
                          )
                        : Stack(
                  ...
                  8.height,
                  Text('Recommended sizes: 180x180 px.', style: secondaryTextStyle(size: 12)).center(),
                  16.height,
                  AppTextField(
                    ...
                    maxLines: 1,
                    decoration: inputDecorationFilled(context, label: 'Highlight Name', fillColor: context.scaffoldBackgroundColor),
                  ),
                ],
              )
            else
              Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Select Category', style: boldTextStyle()).paddingSymmetric(vertical: 16),
              ...
              onTap: () async {
                if (showNewCategory) {
                  if (categoryName.text.isNotEmpty) {
                    ...
                    toast('Please add Highlight Name');
                  }
                } else {
                  //onAddStory();
                }
              },
              child: Text('Add Story', style: primaryTextStyle(color: Colors.white)),
              color: context.primaryColor,
              elevation: 0,
            ),
            16.height,
