                                ...
                                children: [
                                  ...
                                  if (post.content.validate().isNotEmpty)
                                    Align(
                                      ...
                                      child: post.type == PostActivityType.newBlogPost
                                          ? InkWell(
                                              onTap: () async {
                                                if (post.blogId != null) {
                                                  appStore.setLoading(true);
                                                  await wpPostById(postId: post.blogId.validate()).then((value) {
                                                    appStore.setLoading(false);
                                              ...
                                              child: HtmlWidget(postContent: post.content.validate()),
                                            )
                                          : Text(
                                              parseHtmlString(post.content.validate().replaceAll("\n", '')),
